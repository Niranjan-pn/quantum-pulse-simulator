...
import qutip
from ats_device import get_ats_parameter, sweet_spot, working_spot, eta,DISPLACEMNT_PULSE_LENGTH,amp_1_alpha_working_spot
import pprint as pp
import numpy as np
...
def Run_Kerr_angle(alpha_target, ax=None):
    ...
    for angle in probe_angles:
        ...
        sim.simulate(batch_size=1000, save_prefix=f"ATS_kerr_out_in_out", store_batch_file=False)
...
if __name__ == "__main__":
    ...
    plt.title(f"ATS Kerr - Drift Angle vs Alpha Target (Kerr: {popt_kerr_kerr_prime[1]:.2f}, Kerr Prime: {popt_kerr_kerr_prime[2]:.2f})")
    ...
    filename = "kerr_out_in_out_results.json"
