...
from ats_device import get_ats_parameter_4_junctions, sweet_spot, working_spot_4_junctions, eta, DISPLACEMNT_PULSE_LENGTH
import pprint as pp
import numpy as np
import matplotlib.pyplot as plt
import json
from datetime import datetime
dc, ac_plus, ac_minus, omega = get_ats_parameter_4_junctions(*working_spot_4_junctions)
import os
#========================
# Experiment imports
#========================
...
if DISPLACE_AND_PLOT:
    ...
    with open(f"{data_save_path}/drift_angles_vs_alpha_N4_{date_time}.json", "w") as f:
        json.dump(data, f)
    ...
    plt.savefig(f"{data_save_path}/delta_drift_angle_vs_alpha_N4_{date_time}.png")
    plt.show()
