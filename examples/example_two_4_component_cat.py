...
from quantum_pulse_simulator.pulse import flattop_gaussian_shape, TwoPhotonDrivePulse, PulseChain,BeamSplitterPulse, WaitingPulse,ControlledCouplingPulse,TwoModeBeamSplitting
...
def main():
    ...
    bs1 = TwoModeBeamSplitting(
        duration=PULSE_DURATION,
        strength=KERR_COEFF/5,
        all_systems=SYSTEMS,
        interacting_systems=[kerr_osc_1, ho],
        tone=None,
        shape=pulse_shape,
        phase=0.0,
        name="fc",
    ...
    bs2 = TwoModeBeamSplitting(
        duration=PULSE_DURATION,
        strength=KERR_COEFF/5,
        all_systems=SYSTEMS,
        interacting_systems=[kerr_osc_2, ho],
        tone=None,
        shape=pulse_shape,
        phase=0.0,
        name="fc",
    ...
    ccp = ControlledCouplingPulse(
        duration=PULSE_DURATION,
        strength=KERR_COEFF/5,
        all_systems=SYSTEMS,
        interacting_systems=[kerr_osc_1, kerr_osc_2, ho],
        tone=None,
        shape=pulse_shape,
        phase=0.0,
        name="ccp",
    ...
    pulse_chain_bs1 = PulseChain(system=[kerr_osc_1, ho])
    ...
    pulse_chain_bs2 = PulseChain(system=[kerr_osc_2, ho])
    pulse_chain_bs2.add_pulse(waiting_pulse)
    pulse_chain_bs2.add_pulse(bs2)
    # pulse_chain_bs2.add_pulse(waiting_pulse)
