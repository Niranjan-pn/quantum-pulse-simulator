...
def main():
    ...
    for flux_amp in flux_amplitudes:
        ...
        sim.simulate(batch_size=1000, save_prefix=f"SNAIL_Trisq_Amp_{flux_amp:.2f}", store_batch_file=False)
        ...
        xvec = np.linspace(-14, 14, 120)
        yvec = np.linspace(-14, 14, 120)
