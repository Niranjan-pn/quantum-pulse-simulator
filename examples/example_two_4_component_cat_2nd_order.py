...
ALPHA_TARGET = 3 # Target coherent state amplitude

# =========================
# Pulse Parameters 
# =========================
PULSE_DURATION = 1500e-9 #1500E-9  # Total pulse duration (s)
...
def main():
    ...
    ps_bs_1.add_two_photon_exchange(
    ...
    ps_bs_2.add_two_photon_exchange(
        duration=PULSE_DURATION_BS,
        strength=KERR_COEFF/10,
        system1=Kerr_osc_2,
        system2=ho,
    ...
    # Run simulation
    sim.simulate(save_dir=r"D:\PhD_All_Code\quantum-pulse-simulator\examples\results\four_component_2_photon_exchange",
                 batch_size=1000,
                 save_prefix="4_component_cat_2_photon_exchange",)
    ...
    sim.animate_wigner(
        ...
        fps=25,
        save_path="4_component_cat_2photon_exchange.gif",
    )
